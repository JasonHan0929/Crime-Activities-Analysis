...
def female(line):
	...
	if demographic == "Female" and year in year_list:
...
if __name__ == "__main__":
    ...
    line = line.map(female).filter(lambda x:x[0]!= "Not relevant").sortByKey()
    line.saveAsTextFile("2006-2010_female_graduation.out")

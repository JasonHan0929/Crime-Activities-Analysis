...
with open("2006-2010_male_graduation.csv") as csvfile_gra:
	readCSV_gra = csv.reader(csvfile_gra, delimiter=',')
	for row in readCSV_gra:
		male_graduation_2006_2010.append(float(row[1]))


co = pearsonr(crime_per_capita_2006_2010,male_graduation_2006_2010)
print(co)

...
color_sequence = ['#1f77b4', '#660000','#2ca02c']
...
ax.set_ylim(55344, 260993)

plt.xticks(range(2006, 2016, 1), fontsize=14)
plt.yticks(range(55344,269093,10000), fontsize=14)
...
with open('level_year_amount.csv','r') as csvfile:
...
plt.xlabel('Year')
plt.ylabel('Amount')
fig.suptitle('Yearly Amount of 3 Levels Crime of NYC (2006-2015)\n', fontsize=18, ha='center')
plt.legend()
plt.show()

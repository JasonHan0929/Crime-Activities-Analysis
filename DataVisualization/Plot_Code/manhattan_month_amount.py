...
ax.set_xlim(1, 13)
ax.set_ylim(6977, 10445)

plt.xticks(range(1, 13, 1), fontsize=14)
plt.yticks(range(6977,10445,300), fontsize=14)
...
with open('manhattan_month_amount.csv','r') as csvfile:
...
fig.suptitle('Monthly Amount of Crime in Manhattan (2006-2015)\n', fontsize=18, ha='center')
plt.show()
